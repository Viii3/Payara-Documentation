...
**** xref:Technical Documentation/Ecosystem/IDE Integration/NetBeans Plugin/Building NetBeans Plugin.adoc[Building NetBeans Plugin]
*** VSCode Extension
...
** xref:Technical Documentation/Dependencies/Eclipse MicroProfile.adoc[Eclipse MicroProfile]
** xref:Technical Documentation/Dependencies/Internal Dependencies.adoc[Internal Dependencies]
** xref:Technical Documentation/Dependencies/Jakarta EE.adoc[Jakarta EE]
